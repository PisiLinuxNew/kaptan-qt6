...
from PyQt6.QtWidgets import QWizardPage, QLabel, QGroupBox, QListWidget, QVBoxLayout, QSpacerItem, QSizePolicy, QHBoxLayout,\
...
class WallpaperWidget(QWizardPage):
    def __init__(self, parent=None):
        ...
        vlayout.addItem(QSpacerItem(20, 60, QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred))
        ...
        hlayout.addItem(QSpacerItem(400, 20, QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred))
        ...
        for folder in os.listdir(wallpaperPath):
            ...
            for thumb in thumbFolder:
                if thumb.startswith("scre"):
                    ...
                    pix = pix.scaled(QSize(240, 140), Qt.AspectRatioMode.IgnoreAspectRatio, Qt.TransformationMode.FastTransformation)
    ...
    def execute(self):
        if self.selectWallpaper is None:
            ...
            if wallpaper:
                ...
                parser.addWallpaper(self.selectWallpaper)
                if wallpaper:
                    parser.setWallpaper(self.selectWallpaper)