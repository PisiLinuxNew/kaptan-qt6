...
from PyQt6.QtWidgets import QWizardPage, QLabel, QGroupBox, QHBoxLayout, QSpacerItem, QSizePolicy, QVBoxLayout
...
class SummaryWidget(QWizardPage):
    def __init__(self, parent=None):
        ...
        self.labelSummary.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignTop)
        groupLayout.addWidget(self.labelSummary)
        self.labelSummary2 = QLabel()
        self.labelSummary2.setAlignment(Qt.AlignmentFlag.AlignLeading|Qt.AlignmentFlag.AlignLeft|Qt.AlignmentFlag.AlignTop)
