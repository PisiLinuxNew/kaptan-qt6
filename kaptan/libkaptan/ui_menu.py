...
from PyQt6.QtWidgets import QWizardPage, QLabel, QVBoxLayout, QSpacerItem, QSizePolicy, QHBoxLayout, QComboBox
...
class MenuWidget(QWizardPage):
    def __init__(self, parent=None):
        ...
        hlayout.addItem(QSpacerItem(20, 50, QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred))
