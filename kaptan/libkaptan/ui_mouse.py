...
from PyQt6.QtWidgets import QWizardPage, QLabel, QGroupBox, QRadioButton, QHBoxLayout, QVBoxLayout, QCheckBox, \
...
class MouseWidget(QWizardPage):
    def __init__(self, parent=None):
        ...
        vlayout.addItem(QSpacerItem(20, 100, QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred))
    ...
    def execute(self):
        settings1 = QSettings(join(QDir.homePath(), ".config", "kcminputrc"), QSettings.Format.IniFormat)
        settings2 = QSettings(join(QDir.homePath(), ".config", "kdeglobals"), QSettings.Format.IniFormat)
