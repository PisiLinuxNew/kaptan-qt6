...
from PyQt6.QtWidgets import QWizardPage, QLabel, QGroupBox, QPushButton, QVBoxLayout, QSpacerItem, QSizePolicy, QHBoxLayout
...
class OtherWidget(QWizardPage):
    def __init__(self, parent=None):
        ...
        groupHLayout1.addItem(QSpacerItem(40, 20, QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred))
        ...
        groupHLayout2.addItem(QSpacerItem(40, 20, QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Preferred))
    ...
    def systemSettingsOpen(self):
        ...
        # procSettings.startDetached("killall", ["systemsettings"])
        # procSettings.waitForStarted(1000)
        procSettings.startDetached("systemsettings")
